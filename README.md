[![CircleCI](https://app.circleci.com/pipelines/github/samhmariam/Deploy-ML-Microservices-API.svg?style=svg)](https://app.circleci.com/pipelines/github/samhmariam/Deploy-ML-Microservices-API)


## Deploy a containerized, machine learning application using Kubernetes.
...
* [Operationalize a Machine Learning Microservice API](https://github.com/udacity/DevOps_Microservices/tree/master/project-ml-microservice-kubernetes): 
